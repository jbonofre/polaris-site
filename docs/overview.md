...
Apache Polaris (incubating)&trade; is a catalog implementation for Apache Iceberg&trade; tables and is built on the open source Apache Iceberg&trade; REST protocol.
...
In the following diagram, a sample Apache Polaris (incubating) structure with nested namespace is shown for Catalog1. No tables or namespaces have been created yet for Catalog2 or Catalog3.
